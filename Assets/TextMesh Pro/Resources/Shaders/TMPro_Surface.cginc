...
void PixShader(Input input, inout SurfaceOutput o)
{
	...
	faceColor *= tex2D(_FaceTex, float2(input.uv2_FaceTex.x + _FaceUVmovement_speedX * _Time.y, input.uv2_FaceTex.y + _FaceUVmovement_speedY * _Time.y));
	outlineColor *= tex2D(_OutlineTex, float2(input.uv2_OutlineTex.x + _OutlineUVmovement_speedX * _Time.y, input.uv2_OutlineTex.y + _OutlineUVmovement_speedY * _Time.y));
